...
<body>
	...
	<div class="clearfix hidden-sm hidden-xs" style="color:white;background-color: #1049a3; margin-top:-15px; margin-bottom: 12px"><marquee>Welcome to Tender Management Site</marquee>
