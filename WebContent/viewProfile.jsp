...
<html lang="en">
  <head>
    ...
    <title>Digital Project Bidding Management System</title>
...
<body>
	...
	<div class="clearfix hidden-sm hidden-xs" style="color:white;background-color: #1049a3; margin-top:-15px; margin-bottom: 12px"><marquee>Welcome to the Digital Project Bidding Management System</marquee>
   ...
   <div class="col-md-8">
	...
	%>
		...
		<table style="background-color:white">
			...
			<tr><td style="color:#1049a3">	Vendor Id  : </td><td><%= vendor.getId()%></td></tr>
			<tr><td style="color:#1049a3">    Vendor Name: </td><td><%= vendor.getName()%></td></tr>
		   <tr><td style="color:#1049a3">	Mobile No.    :</td><td> <%= vendor.getMobile()%></td></tr>
	       <tr><td style="color:#1049a3"> Email Id :</td><td> <%= vendor.getEmail()%></td></tr>
		   <tr><td style="color:#1049a3">	Address  : </td><td><textarea rows="2" cols="40" style="font-size:15px" name="vaddr" readonly><%=vendor.getAddress() %> </textarea></td></tr>
		   <tr><td style="color:#1049a3">	Company Name : </td><td> <%= vendor.getCompany()%></td></tr>
			<tr><td style="color:#1049a3" colspan="2" align="center" value="Launch"><a href="updateProfile.jsp" style="color:#1049a3">Click Here To Update Profile</a></td></tr>
