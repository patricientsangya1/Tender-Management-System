...
<html lang="en">
  <head>
    ...
    <title>DigitalProject Bidding Management System</title>
...
<body>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white; padding-top:0px;">
        ...
        <div class="marquee-content" style="align:center; padding-top:100px;min-height:750px;background-color:white">
