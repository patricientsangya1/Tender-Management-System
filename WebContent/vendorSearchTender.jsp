...
<body>
	...
	<div class="clearfix hidden-sm hidden-xs" style="color:white;background-color: green; margin-top:-15px; margin-bottom: 12px"><marquee>Welcome to the Digital Project Bidding Management System</marquee>
