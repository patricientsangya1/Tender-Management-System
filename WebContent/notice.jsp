...
<body>
          ...
          <div class="marquee" style="border:2px #1049a3 solid;background-color:white">
          <h4 style="background-color:#1049a3; margin-top:-1.8px; padding: 5px;"><i class="glyphicon glyphicon-volume-up"></i> 
