...
<body>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
        <h4 style="background-color:#1049a3; margin-top:-1.8px; margin-bottom:1px;padding: 5px; text-align: center;color:white;font-weight:bold">
        ...
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:750px;background-color:cyan">
     		<h1><center>Hey Admin! Welcome to the Digital Project Bidding Admin Page</center></h1>
     		<h2><center>On this page, you will be able to perform a variaty of tasks on vendors such as, add tenders and assign it to vendors according to their high bids</center></h2>
