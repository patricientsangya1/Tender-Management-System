...
<body>
	...
	<div class="clearfix hidden-sm hidden-xs"
		style="color: white; background-color: #1049a3; margin-top: -15px; margin-bottom: 12px">
		<marquee>Welcome to the Digital Project Bidding Management System</marquee>
	</div>
	...
	<div class="container-fluid">
        ...
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:750px;background-color:cyan">
			...
			<table style="background-color: white">
				<tr
					style="color: white; font-size: 18px; font-weight: bold; background-color: #1049a3">
					<td>Bidder Id</td>
					<td>Vendor Id</td>
					<td>Bid Amount</td>
					<td>Deadline</td>
